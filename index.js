var mensData = [
  ...
  var newarr=JSON.parse(localStorage.getItem("add_to_cart"))||[];
  ...
  mensData.map(function(elem){
      ...
      name.style.color="blueviolet"
      price.innerText=elem.price;
      price.style.color="blue"
      sprice.innerText=elem.strikedoffprice;
      sprice.style.color="red"
      sprice.style.textDecoration="line-through";
      btn.innerText="Add to Cart"
      btn.style.color="blue"
      btn.style.background="rgb(67, 170, 170)"
      btn.style.padding="5px 7px 5px 7px"
